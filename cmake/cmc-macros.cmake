...
## Sets the variable <subdirectoryName>_ADDED (in uppercase) to True or False accordingly to the result.
## 
## \\code
...
function(CONDITIONAL_ADD_SUBDIRECTORY subdirectory)
	...
	if(NOT missingDep_list AND NOT missingOpt_list)
        ...
        set(${upper_directory}_ADDED ON CACHE INTERNAL "" FORCE)

    else()
        set(${upper_directory}_ADDED OFF CACHE INTERNAL "" FORCE)
