...
SCENARIO("Family management on entities addition/removal")
{
    ...
    {
        Engine engine;
        EntityList & NodesOfArchetypeA = engine.getEntities<ArchetypeA>();
...
SCENARIO("Family observation")
{
    GIVEN("An Engine, an Observer and an Archetype")
    {
        ...
        engine.registerToFamily<ArchetypeA>(&observer);
        ...
        GIVEN("A second observer")
        {
            ...
            engine.registerToFamily<ArchetypeA>(&posterioriObserver);
